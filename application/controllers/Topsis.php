...
class Topsis extends CI_Controller
{
    ...
    {
        $data['title'] = 'Penilaian dan Hasil | SPK APP';
		$data['page'] = 'Penilaian dan Hasil SPK TOPSIS';
        $data['tabel'] = $this->m_topsis->get_tabell();

        $this->template->load('templates/template','topsis/topsis', $data);
    }    
