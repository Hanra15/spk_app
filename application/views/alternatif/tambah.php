          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- <p>Add lightweight datatables to your project with using the <a href="https://github.com/fiduswriter/Simple-DataTables" target="_blank">Simple DataTables</a> library. Just add <code>.datatable</code> class name to any table you wish to conver to a datatable</p> -->
				...
				<form action="<?php echo site_url('alternatif/tambah'); ?>" method="post">
					<div class="mb-3">
						<label for="nama_alternatif" class="mb-3">Nama Alternatif</label>
						<input name="nama_alternatif" id="nama_alternatif" class="form-control" required type="text" value="<?php echo set_value('nama_alternatif'); ?>" style="width: 30% !important;">
					</div>
